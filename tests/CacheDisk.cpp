...
TEST_CASE( "CacheMemory multiple remove", "[libopenshot][cache]" )
{
...
TEST_CASE( "CacheDisk::SetMaxBytes", "[libopenshot][cache]" )
{
...
TEST_CASE( "CacheDisk multiple remove", "[libopenshot][cache]" )
{

...
TEST_CASE( "Width_and_Height_Functions", "[libopenshot][timeline]" )
{
	// Create a default fraction (should be 1/1)
	Fraction fps(30000,1000);
	Timeline t1(640, 480, fps, 44100, 2, LAYOUT_STEREO);
...
TEST_CASE( "Check_Two_Track_Video", "[libopenshot][timeline]" )
{
	// Create a reader
...
TEST_CASE( "Clip_Order", "[libopenshot][timeline]" )
{
	// Create a timeline
...
TEST_CASE( "Effect_Order", "[libopenshot][timeline]" )
{
	// Create a timeline
	Timeline t(640, 480, Fraction(30, 1), 44100, 2, LAYOUT_STEREO);
...
TEST_CASE( "GetClip_by_id", "[libopenshot][timeline]" )
{
	Timeline t(640, 480, Fraction(30, 1), 44100, 2, LAYOUT_STEREO);
...
TEST_CASE( "GetClipEffect_by_id", "[libopenshot][timeline]" )
{
	Timeline t(640, 480, Fraction(30, 1), 44100, 2, LAYOUT_STEREO);
...
TEST_CASE( "GetEffect_by_id", "[libopenshot][timeline]" )
{
	Timeline t(640, 480, Fraction(30, 1), 44100, 2, LAYOUT_STEREO);
...
TEST_CASE( "Effect_Blur", "[libopenshot][timeline]" )
{
	// Create a timeline
	Timeline t(640, 480, Fraction(30, 1), 44100, 2, LAYOUT_STEREO);
...
TEST_CASE( "GetMaxFrame_GetMaxTime", "[libopenshot][timeline]" )
{
	// Create a timeline
	Timeline t(640, 480, Fraction(30, 1), 44100, 2, LAYOUT_STEREO);
